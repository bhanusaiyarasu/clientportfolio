...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const onHover = () => {
      gsap.to(penRef.current, { scale: 1.25, duration: 0.2, ease: 'back.out(1.7)' })
      gsap.to(glowRef.current, { scale: 2.2, opacity: 0.8, duration: 0.2 })
    }
    const onLeave = () => {
      gsap.to(penRef.current, { scale: 1, duration: 0.2 })
  ...
  return (
    <div className="cursor-wrap">
      ...
      {/* Accent glow behind cursor */}
      <div className="cursor-pen-glow" ref={glowRef} />
    </div>
  )
}
